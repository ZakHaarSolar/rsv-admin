...
- **🧠 QWEN3.8 35B A3B PARA LA MAC — consulta respondida (2026-08-17).** Zak vio
  ...
  **Recomendación: SÍ, es el candidato correcto para esta Mac, pero se prueba
  cuando salgan los pesos y se mide contra el 27B en el MISMO encargo antes de
  cambiar nada.** Por qué es el candidato: los 35B son el tamaño TOTAL y solo
  ~3B se activan por token (es una mezcla de expertos). En una MacBook Pro M3 de
  48 GB, donde el cuello de botella no es la memoria sino el ANCHO DE BANDA, lo
  que manda el tiempo es cuántos parámetros hay que leer por token: leer 3B en
  vez de 27B es estructuralmente varias veces más rápido, tanto al escribir como
  al LEER el encargo, que es donde más duele (medido el 2026-08-16 · VI: 29,3 s
  solo en digerir los 6.042 tokens del Nodo A antes de la primera letra). Cabe
  de sobra: a Q4 pesaría ~20-22 GB contra los 18 de ahora.
  · **Lo que se paga:** profundidad por token. Una mezcla con 3B activos razona
  más cerca de un denso de 10-14B que de uno de 27B. Para el bucle, donde el
  documento es largo y las etapas son cortas, la velocidad probablemente gana;
  para una pregunta difícil de una sola pasada, no está claro.
  · **Cómo se decide sin adivinar:** los dos modelos caben a la vez en 48 GB, así
  que se corre el MISMO ciclo del Nodo A con cada uno y se comparan dos números
  (segundos hasta la primera letra y tokens por segundo) y una lectura de Zak
  sobre la calidad. Es media hora de trabajo y cierra el caso.
