...
/* 🔆 Hook global de tema */
import { useSolarTheme } from "./useSolarTheme.ts"
...
export function FragmentosDelSolMobile(props: any) {
    ...
    /* 🎨 Escucha tema global (sin toggle local) */
    const { synced, accent, toggleTheme, isNeon } = useSolarTheme({
