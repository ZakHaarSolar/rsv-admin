// ════════════════════════════════════════════════════════════════════
// Red Solar Viva — Edge Function `destilar-nodo` (v1.5)
// v1.5 — AUDITORÍA PARTE 4 — gobernador de gasto reserve_edge_spend (Gemini
// 3.1 Pro preview / 2.5 Pro). Cota por-usuario 25/día + global 60/día, justo
// después de armar el contexto y antes de llamar a Gemini.
...
/* AUDITORÍA PARTE 4 · gobernador de gasto. Gemini 3.1 Pro preview / 2.5 Pro
   ...
   responde, la operación sigue (nunca rompe una destilación legítima). Sin
