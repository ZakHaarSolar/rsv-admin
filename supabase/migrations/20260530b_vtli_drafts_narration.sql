-- 20260530b_vtli_drafts_narration.sql
-- Agrega `narration` (guion de voz en off para ElevenLabs) a vtli_drafts
-- y lo expone en los dos RPCs de lectura (recent + by_ids). Aplicar
-- pegando este archivo completo en Supabase Dashboard → SQL Editor → Run.

ALTER TABLE public.vtli_drafts
    ADD COLUMN IF NOT EXISTS narration text;

COMMENT ON COLUMN public.vtli_drafts.narration IS
    'Guion de voz en off del Reel, en español, para pasar por ElevenLabs (TTS manual). Generado por generate-vtli-storyboard v1.1+.';

-- ============================================================
-- get_recent_vtli_drafts — + narration
-- ============================================================
...
-- ============================================================
-- get_vtli_drafts_by_ids — + narration
-- ============================================================
...
-- ============================================================
-- Fin de migración 20260530b_vtli_drafts_narration.sql
-- ============================================================
