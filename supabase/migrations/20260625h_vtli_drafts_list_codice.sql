-- 20260625h_vtli_drafts_list_codice.sql
-- Atelier · Estudio Manual (Zak'Haar Video) — el listado de borradores ahora
-- devuelve codice_id + codice_title de cada storyboard, para que el panel pueda
-- mostrar "por defecto el Códice que se usó" en el regenerador de narración
-- (función nueva: pedir otra versión de la voz en off, opcionalmente desde otro
-- Códice). La columna codice_id ya existe en vtli_drafts (20260624b); aquí solo
-- re-creamos las dos RPC de lectura para incluirla. Sin cambios de schema.
-- Pegar en Supabase Dashboard → SQL Editor → New Query → Run.

-- ============================================================
-- 1. get_recent_vtli_drafts — + codice_id + codice_title
-- ============================================================
...
-- ============================================================
-- 2. get_vtli_drafts_by_ids — + codice_id + codice_title
-- ============================================================
